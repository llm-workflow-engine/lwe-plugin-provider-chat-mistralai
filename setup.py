...
setup(
    name="lwe-plugin-provider-chat-mistralai",
    version=version,
    author="Chad Phillips",
    author_email="chad@apartmentlines.com",
    description="LWE plugin: Chat MistralAI Provider plugin",
    ...
    entry_points={
        "lwe_plugins": [
            "lwe_plugin_provider_chat_mistralai = lwe_plugin_provider_chat_mistralai.plugin:ProviderChatMistralai"
        ]
    },
)
